...
function OrderItem() {
    ...
    const { image, title, price, setTitle, setImage, currency, setCurrency, setPrice } = useContext(OrderContext)
    ...
    useEffect(() => {
        ...
        const fetchItem = async () => {
            try {
                let response = await api.get(`/${category}/info/?id=${itemId}`)
