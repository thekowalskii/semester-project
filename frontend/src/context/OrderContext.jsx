...
const OrderContextProvider = ({ children }) => {
	...
	const [ novaDepartment, setNovaDepartment ] = useState(null)
	const [ novaCourier, setNovaCourier ] = useState(null)
